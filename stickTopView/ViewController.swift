...
//  stickTopView
//
//  Created by AFFIXUS IMAC1 on 9/28/18.
...
class ViewController: UIViewController {
    ...
    @IBAction func btAction(_ sender: UIButton) {
        ...
        btText.contentHorizontalAlignment = .left
//        btText.tintColor = .clear
        // Create a custom view for testing...
        let customView = csView
    ...
    @IBAction func btEmail(_ sender: UIButton) {
        ...
        else
        {
            ...
            imgEmail.backgroundColor = .green
        }
